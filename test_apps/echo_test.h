...
#define DEV_NAME_3 "/dev/vsi_write"
#define DEV_NAME_4 "/dev/vsi_read"
#define DEV_NAME_5 "/dev/vsi_write_2"
#define DEV_NAME_6 "/dev/vsi_read_2"
#define DEV_NAME_7 "/dev/vsi_write_3"
#define DEV_NAME_8 "/dev/vsi_read_3"
